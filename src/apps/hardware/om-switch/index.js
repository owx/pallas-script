#!/usr/bin/env node
import { downloadOmAudioFiles, downloadFileWithProxy, uploadFile } from "./core.js";

export async function omMain(){
  ...
  // uploadFile("https://chifeng-nx.njapld.com:7979/admin/obs/uploadFile", "123", "D:\\Temp\\IMG_132154484020447264.jpg" )
